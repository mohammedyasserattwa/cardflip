                          ...
                          children: [
                            Deck(
                                onTap: () {
                                  Navigator.of(context)
                                      .pushNamed("/deck", arguments: {
                                    "deckID": deckModel.userPreferences[0].id,
                                  });
                                },
                                width: 125.04,
                                height: 103.8,
                            ...
                            Deck(
                                onTap: () {
                                  Navigator.of(context)
                                      .pushNamed("/deck", arguments: {
                                    "deckID": deckModel.userPreferences[1].id,
                                  });
                                },
                          ...
                          children: [
                            Deck(
                                onTap: () {
                                  Navigator.of(context)
                                      .pushNamed("/deck", arguments: {
                                    "deckID": deckModel.userPreferences[2].id,
                                  });
                                },
                            ...
                            Deck(
                                onTap: () {
                                  Navigator.of(context)
                                      .pushNamed("/deck", arguments: {
                                    "deckID": deckModel.userPreferences[3].id,
                                  });
                                },
                ...
                child: NoGlowScroll(
                    child: ListView.separated(
                        ...
                        itemBuilder: (context, index) =>
                            CategoryCard(category: user.categories[index]))),
              ),
            ),
          ],
        ),
